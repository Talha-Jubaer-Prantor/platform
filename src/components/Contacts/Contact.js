    ...
    <div>
      ...
      <div style={{ backgroundColor: "gainsboro" }}>
        <div className="py-5 text-center mb-5">
          ...
          <p className="text-color fw-bold  fs-5">
            {" "}
        ...
        <div className="my-5">
          <div className="container row gx-4 mx-auto">
            <div className="col-lg-7 col-md-7 col-12">
              <form className="border p-5">
                <h1 className="text-start">
                  Interested in{" "}
                  <span style={{ color: "purple" }}>discussing</span> ?
                </h1>
                <p
                  style={{
                    fontSize: "15px",
                ...
                >
                  You Could fill-up this form to contact with us.
                </p>
                <div className="my-4">
                  <input
                    type="text"
            ...
            <div className="col-lg-5 col-md-5 col-12 mt-4">
              <div
                style={{
                  boxShadow: " 2px 3px 6px #00000073, -6px -6px 16px white",
                }}
                className="row my-3 py-3 rounded"
              >
                <div className="col-3 my-3 border-end border-2 d-flex align-items-center justify-content-center">
                  <span className="text-dark" style={{ fontSize: "50px" }}>
                    <i className="fas fa-phone-square-alt fs-1 "></i>
                  </span>
                </div>
              ...
              >
                <div className="col-3 my-3 border-end border-2 d-flex align-items-center justify-content-center">
                  <span className=" text-dark" style={{ fontSize: "50px" }}>
                    <i className="fas fa-envelope-square fs-1"></i>
                  </span>
                </div>
                <div className="col-9 ps-4 pt-2">
              ...
              >
                <div className="col-3 my-3 border-end border-2 d-flex align-items-center justify-content-center">
                  <span className="text-dark" style={{ fontSize: "50px" }}>
                    <i className="fas fa-globe fs-1"></i>
                  </span>
                </div>
                <div className="col-9 ps-4 pt-2">
